...
to modify it, which could lead to unexpected behaviors, specially sicne there is
...
when it is acknowledged as a worthwhile learning endeavour by the school's
faculty.
...
Nonetheless, we've had the occasion to explore many different domains of
computer engineering, from software architecture to cryptography.
We attained our objectives in terms of featureset, and managed to do so while
keeping our code clean and faithful to its own principles.
