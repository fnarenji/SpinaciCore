...
\begin{itemize}
    ...
    \item \texttt{ClientLogonProof}
        ...
        same shared key and compares de proof to the expected proof generated from the
        shared key and the client key. 

    \item \texttt{ServerLogonProof}
        Wether the expected proof is matched or not, an instance of the packet 
...
The characters creation handler tests the validity of some fields and if successfull,
