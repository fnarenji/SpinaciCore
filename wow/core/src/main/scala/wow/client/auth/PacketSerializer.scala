...
case class PacketSerializationException(err: Err)
  extends IOException(s"Packet couldn't be written: $err")
...
object PacketSerializer {
  /**
    ...
    */
  def serialize[A <: ClientPacket](value: A)(implicit codec: Codec[A]): BitVector = {
  ...
  /**
    ...
    */
  def deserialize[A <: ServerPacket](bits: BitVector)(implicit codec: Codec[A]): A = {
